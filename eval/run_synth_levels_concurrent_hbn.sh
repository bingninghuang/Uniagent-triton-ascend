...
REPO_ROOT="${REPO_ROOT:-/home/h00961522/Triton-Training-new}"
DATASET="${DATASET:-/home/h00961522/data/eval_data/NPUKernelBench}"
OUT_ROOT="${OUT_ROOT:-/home/h00961522/Triton-Training-new/eval/output}"
...
EVAL_DEVICE_IDS="${EVAL_DEVICE_IDS:-0,1,2,3}"
...
export no_proxy="${no_proxy:-127.0.0.1,localhost,0.0.0.0,80.5.5.100,80.48.17.181,80.5.5.104}"
export NO_PROXY="${NO_PROXY:-$no_proxy}"
export TRITON_TRAIN_BEST_FIRST="${TRITON_TRAIN_BEST_FIRST:-0}"
# -----------------------------------------------------------------------------
# Parse device list
# -----------------------------------------------------------------------------
...
run_worker() {
  ...
  while :; do
    ...
    if ! docker exec "${SYNTH_CONTAINER}" bash -lc "
      ...
      TRITON_TRAIN_BEST_FIRST='${TRITON_TRAIN_BEST_FIRST}' \
